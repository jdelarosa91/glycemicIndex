...
namespace Iglycemicindex_project.Common
{
    /// <summary>
    /// NavigationManager es útil para la navegación entre páginas.  Proporciona comandos que se usan para 
    /// navegar hacia detrás y hacia delante, además de registros de los accesos directos 
    /// de mouse y teclado estándar usados para retroceder y avanzar.  Además, integra SuspensionManager
    /// para controlar la administración del estado y de la duración de los procesos al navegar entre
    /// páginas.
    /// </summary>
    /// <example>
    /// Para usar NavigationManager, realice los dos pasos siguientes o bien
    ...
    /// </code>
    /// 
    /// 2) Registrar la página para llamar a NavigationManager siempre que la página participe 
