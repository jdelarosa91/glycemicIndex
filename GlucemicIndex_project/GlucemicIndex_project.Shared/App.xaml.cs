    ...
    public sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                if (localSettings.Values["data_base_version"] == null)
                {
                    // No data
                    db = new DatabaseController();
                    db.insertDB();
                    localSettings.Values["data_base_version"] = DATABASE_VERSION;
                }
                else if ((int)localSettings.Values["data_base_version"]<DATABASE_VERSION)
                {
                    localSettings.Values["data_base_version"] = DATABASE_VERSION;
                    db = new DatabaseController();
                    db.deleteDB();
